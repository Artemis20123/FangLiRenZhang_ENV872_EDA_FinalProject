...
#note, plot 1, right side not fit, maybe remove these.plot4 dash line --outlayer
...
plot(TPregression)
par(mfrow = c(1,1))
#note, plot1 , wnat the red line flat.
...
#note--thin----stright estimation line. color---positive to negative.
...
##note when check AIC, value, when the value increase with removing, it means the condition become worse. it end with the AIC not decrease. and get the best estimated regression.
## note, meanwhile the end of the result aslo shows the Coef
```