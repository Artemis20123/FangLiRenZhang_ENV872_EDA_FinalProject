...
-   since the .nc files are too large (GB level), they are not included in the folder
...
-   aggregate all the daily_split .csv files to a comprehensive dataset
...
-   Match the Chinese and English city names
