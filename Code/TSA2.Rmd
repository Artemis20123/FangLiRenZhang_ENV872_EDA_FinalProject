...
```
#Notice
I don't know where the conflict occurred, the checkresiduals run of chunk4 can't come out.
This problem come after i run the dashboard.But the whole document can be knit
