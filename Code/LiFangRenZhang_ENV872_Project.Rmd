...
```{r seasonal figure, fig.cap="Seasonality in PM2.5 in 7 Chinese Cities", echo=FALSE, message=FALSE, warning=FALSE}
...
```{r trend figure, fig.cap="Trends in PM2.5 in 7 Chinese Cities",echo=FALSE, message=FALSE, warning=FALSE}
...
We visualized the annual average concentration of PM2.5 in Chinese cities from 2000 to 2021 and analyzed the historical trends and predicted the concentration changes for the next 5 years in megacities. Our results show that the PM2.5 concentration increased from 2000 to 2013, with higher concentrations in the eastern regions compared to the western and southern regions. Since 2014, PM2.5 concentration in China has been decreasing. The concentration during autumn and winter was higher than that during spring and summer. Combining the SRIMA and SSES models resulted in the most accurate prediction. Our findings suggest that the PM2.5 concentration will continue to decrease in the next five years.
