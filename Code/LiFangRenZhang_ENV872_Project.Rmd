...
2. What might be the monthly average PM2.5 concentrations in these seven cities for the next three years?
...
ggplot(seasonal_data, aes(x = month, y = seasonal, group = city, colour = city)) +
  ...
  labs(title = "Seasonality in PM2.5 in 7 Chinese Cities", x = "Month", y = "PM2.5 Seasonal Component") +
  theme_minimal() +
...
ggplot(trend_data, aes(x = date, y = trend, group = city, colour = city)) +
  geom_line() +
  labs(title = "Trends in PM2.5 in 7 Chinese Cities", x = "Year", y = "PM2.5 Trend Component") +
