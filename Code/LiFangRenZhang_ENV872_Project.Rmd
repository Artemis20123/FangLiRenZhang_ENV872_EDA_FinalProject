...
```{r seasonal figure, fig.cap="Figure 2. Seasonality in PM2.5 in 7 Chinese Cities", echo=FALSE, message=FALSE, warning=FALSE}
...
```{r trend figure, fig.cap="Figure 3. Trends in PM2.5 in 7 Chinese Cities",echo=FALSE, message=FALSE, warning=FALSE}
